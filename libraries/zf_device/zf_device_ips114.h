...
#define IPS114_SCL_PIN                  (C10)                                    // 软件 SPI SCK 引脚
#define IPS114_SDA_PIN                  (C12)                                    // 软件 SPI MOSI 引脚
//====================================================软件 SPI 驱动====================================================
#else
//====================================================硬件 SPI 驱动====================================================
#define IPS114_SPI_SPEED                (18 * 1000 * 1000)                      // 硬件 SPI 速率 这里设置为系统时钟二分频
#define IPS114_SPI                      (SPI_3)                                 // 硬件 SPI 号
#define IPS114_SCL_PIN                  (SPI3_MAP1_SCK_C10)                           // 硬件 SPI SCK 引脚
#define IPS114_SDA_PIN                  (SPI3_MAP1_MOSI_C12)                          // 硬件 SPI MOSI 引脚
//====================================================硬件 SPI 驱动====================================================
#endif

#define IPS114_RST_PIN                  (E0)                                   // 液晶复位引脚定义
#define IPS114_DC_PIN                   (E1)                                   // 液晶命令位引脚定义
#define IPS114_CS_PIN                   (B8)                                   // CS 片选引脚
